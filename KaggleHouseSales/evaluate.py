...
def runAlgorithm():
	...
	continuous_feature_index_tr=continuous_feature_index.tolist()
	categorical_feature_index_tr=categorical_feature_index.tolist()

	continuous_feature_index_ts=continuous_feature_index.tolist()
	categorical_feature_index_ts=categorical_feature_index.tolist()
	...
	xTrain,continuous_feature_index_tr,categorical_feature_index_tr=featureEngineer(xTrain,continuous_feature_index_tr,categorical_feature_index_tr)
